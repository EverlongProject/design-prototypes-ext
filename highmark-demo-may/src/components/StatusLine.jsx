...
// Single status line: sparkle icon + text. Mirrors the Manulife pattern,
// retuned to a Highmark-blue gradient.
function Sparkle() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <defs>
        <linearGradient id="hmSparkGrad" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#0066B1" />
          <stop offset="100%" stopColor="#5BC8E8" />
        </linearGradient>
      </defs>
      <path
        d="M8 1.5l1.6 4.1 4.1 1.6-4.1 1.6L8 12.9 6.4 8.8 2.3 7.2l4.1-1.6L8 1.5z"
        fill="url(#hmSparkGrad)"
      />
    </svg>
  )
}
